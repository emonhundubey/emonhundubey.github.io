...
function toggleDaySelection() {
  const day = this.getAttribute('id');
...
fullDayButton.addEventListener('click', setFullDay);
halfDayButton.addEventListener('click', setHalfDay);
...
function calculateCost() {
  ...
  if (fullDayButton.classList.contains('clicked')) {
    cost += costPerDayFull * dayCounter;
  } else {
    cost += costPerDayHalf * dayCounter;
  }
